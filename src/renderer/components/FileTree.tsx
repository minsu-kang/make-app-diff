...
function getFolderStatus(node: TreeNode): string | null {
...
function collectStatuses(node: TreeNode, s: Set<string>): void {
...
function buildFlatList(root: TreeNode, expandedFolders: Set<string>): FlatItem[] {
